export const AllZones = ['hand', 'board', 'deck', 'graveyard', 'leaderZone', 'creationZone', 'leaderTechniqueZone','passiveZone', 'setAsideZone', 'global'] as const
...
export const LeaderZones = ['leaderZone', 'hand', 'deck', 'graveyard', 'setAsideZone'] as const
export const FollowerZones = ['board', 'hand', 'deck', 'graveyard', 'setAsideZone'] as const
export const CreationZones = ['creationZone', 'hand', 'deck', 'graveyard', 'setAsideZone'] as const
export const MomentZones = ['hand', 'deck', 'graveyard', 'setAsideZone'] as const
export const PassiveZones = ['hand', 'deck', 'graveyard','passiveZone', 'setAsideZone'] as const
export const LeaderTechniqueZones = ['leaderTechniqueZone', 'setAsideZone', 'graveyard'] as const
...
export const ObjectTypes = [...CardTypes, 'Player', 'Enchantment', 'BoardSlot'] as const
...
export const EnchantmentSubtypes = ['Static', 'Aura', 'Trigger'] as const
export const ObjectSubtypes = [...CardSubtypes, ...EnchantmentSubtypes, 'Player', 'BoardSlot'] as const
...
export type EnchantmentSubtypeString = typeof EnchantmentSubtypes[number]
