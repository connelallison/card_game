...
class Popup extends Component {
    ...
    render() {
        ...
        const lines = !welcome ? this.props.message.map(line => <p>{line}</p>) : <div className='welcomeMessage'>
            ...
            <p> This is a demo version of the game, with a prototype browser-based client.</p>
            ...
            <p>Four of the eight classes have been unveiled so far - <strong>Economy</strong>, <strong>Infamy</strong>, <strong>Learning</strong>, and <strong>The People</strong> - each with two or three decks to try. More classes and decks will be added over time, so stay tuned.</p>
