const TargetRequirements = {
    ...
    isCategory: (source: GameObject, target: GameObject, values: { category: FollowerCategoryString }): boolean => ((target as Follower).categories?.[values.category]),
    isCategories: (source: GameObject, target: GameObject, values: { categories: FollowerCategoryString[] }): boolean => (values.categories.some(category => (target as Follower).categories?.[category])),
    isNotCategory: (source: GameObject, target: GameObject, values: { category: FollowerCategoryString }): boolean => (!(target as Follower).categories?.[values.category]),
    isNotCategories: (source: GameObject, target: GameObject, values: { categories: FollowerCategoryString[] }): boolean => !(values.categories.some(category => (target as Follower).categories?.[category])),
