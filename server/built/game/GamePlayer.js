...
var GamePlayer = /** @class */ (function () {
    function GamePlayer(game, name, socketID, bot) {
        ...
        this.health = 20;
        this.hero = new GenericHero_1.default(this.game, this);
        this.maxMana = 2;
        this.currentMana = 2;
        this.hand = [];
        this.maxHand = 7;
    ...
    GamePlayer.prototype.play = function (card) {
    ...
    GamePlayer.prototype.summon = function (cardID) {
        if (this.board.length < this.maxBoard) {
            var card = CardLib_1.create(this.game, this, 'board', cardID);
