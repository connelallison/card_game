    ...
    zones.forEach(zone => {
        switch (zone) {
            ...
            case 'neighbouringFollowers':
                ...
                break
            case 'enemyBoard':
                targetDomain.push(...object.opponent().boardFollowers())
                break
            case 'enemyLeader':
                targetDomain.push(...object.opponent().leaderZone)
                break
            case 'friendlyBoard':
            ...
            case 'friendlyLeader':
                ...
                break
            case 'enemyLeaderTechnique':
                targetDomain.push(...object.opponent().leaderTechniqueZone)
                break
            case 'friendlyLeaderTechnique':
                targetDomain.push(...object.controller().leaderTechniqueZone)
                break
            case 'friendlyPlayer': 
                targetDomain.push(object.controller())
                break
            case 'enemyPlayer': 
                targetDomain.push(object.opponent())
                break
            case 'enemyHand':
                targetDomain.push(...object.opponent().hand)
                break
            case 'friendlyHand':
                targetDomain.push(...object.controller().hand)
                break
            case 'enemyDeck':
                targetDomain.push(...object.opponent().deck)
                break
            case 'friendlyDeck':
                targetDomain.push(...object.controller().deck)
                break
            case 'enemyCreations':
                targetDomain.push(...object.opponent().creationZone)
                break
            case 'friendlyCreations':
                targetDomain.push(...object.controller().creationZone)
                break
            case 'enemyLegacy': 
                targetDomain.push(...object.opponent().legacy)
            case 'friendlyLegacy': 
