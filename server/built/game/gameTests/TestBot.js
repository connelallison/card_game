...
var TestBot = function (game) { return __awaiter(void 0, void 0, void 0, function () {
    var playableCard;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(!game.gameOver && game.turn.activePlayer.bot)) return [3 /*break*/, 2];
                return [4 /*yield*/, game.sleep(1000)
                    // for (card in game.turn.activePlayer.playableCards()) {
                    // }
                ];
            case 1:
                _a.sent();
                playableCard = game.turn.activePlayer.playableCards()[0];
                if (playableCard) {
            ...
            case 2:
                if (!game.gameOver && game.turn.activePlayer.bot) {
                    game.turn.activePlayer.board.filter(function (minion) { return minion.canAttack(); }).forEach(function (minion) {
