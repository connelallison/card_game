...
var Turn = /** @class */ (function () {
    function Turn(game, activePlayer, turnNumber) {
        this.game = game;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.game.sleep(this.turnLength)];
                    case 1:
                        _a.sent();
                        if (!this.over) {
                            this.end();
                            return [2 /*return*/, this.activePlayer.opponent];
                        }
                        else {
    ...
    Turn.prototype.cacheEvent = function (event, type) {
